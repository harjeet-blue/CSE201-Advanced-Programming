    ...
    public static void began(Game g, Dice d) {
        ...
        do {
            ...
            switch (curr + dice) {
                ...
                case 0:
                    curr = g.Empty_Floor_updates(Floor[0]);
                    break;
                case 1:
                    curr = g.Empty_Floor_updates(Floor[1]);
                    break;
                case 2:
                    curr = g.Ladder_floor_updates(floor_2);
                    dice = 0;
                    continue;
                case 3:
                    curr = g.Empty_Floor_updates(Floor[3]);
                    break;
                case 4:
                    curr = g.Empty_Floor_updates(Floor[4]);
                    break;
                case 5:
                    curr = g.Snake_floor_updates(floor_5);
                    dice = 0;
                    continue;
                case 6:
                    curr = g.Empty_Floor_updates(Floor[6]);
                    break;
                case 7:
                    curr = g.Empty_Floor_updates(Floor[7]);
                    break;
                case 8:
                    curr = g.Ladder_floor_updates(floor_8);
                    dice = 0;
                    continue;
                case 9:
                    curr = g.Empty_Floor_updates(Floor[9]);
                    break;
                case 10:
                    curr = g.Empty_Floor_updates(Floor[10]);
                    break;
                case 11:
                    curr = g.Snake_floor_updates(floor_11);
                    dice = 0;
                    continue;
                case 12:
                    curr = g.Empty_Floor_updates(Floor[12]);
                    break;
                case 13:
                    g.game_over();
                    flag = 1;
