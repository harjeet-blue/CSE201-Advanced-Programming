        ...
        do {
            ...
            switch (c) {
                ...
                case 3:
                    ...
                    break;
                case 4:
                    if (check_dependency(4)) {
                        add_slots();
                        v4 = true;
                    } else System.out.println("Either viccines have not been added yet or No Hospital has registered");
                    break;
                case 5:
                    if (check_dependency(5)) {
                        book_slot();
                        v5 = true;
                    } else
                        System.out.println("Either slots have not been added by hospitals or No citizen has registered");
                    break;
                case 6:
                    if (check_dependency(6)) {
                        print_all();
                        v6 = true;
